...
### Базовая задача: Электронный журнал группы 
### Вариативная часть: 3. Находить студента с минимальным баллом 

### Класс для электронного журнала группы
...
### Тестовая функция, демонстрирующая работоспособность основных функций программы
